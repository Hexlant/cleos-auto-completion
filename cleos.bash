...
_cleos ()
{
	...
	local c1=(version create get set transfer net wallet sign push multisig sudo system)
	local c2_version=(client)
	local c2_create=(key account)
	local c2_get=(info block account code abi table currency accounts servants transaction actions schedule)
